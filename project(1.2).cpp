...
Filesys::Filesys(string diskname, int numberofblocks, int blocksize):Sdisk(diskname, numberofblocks, blocksize) {
	...
	*/
	...
	if (user_input == "n" || user_input == "N") {
		...
		cout << "The pre-existing filesystem may not work with your Operating System!\n";
	}
}
...
int main() {
	...
	//we cannot delete the entry in fat that designates the end of that file (fat = 0)
